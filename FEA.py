...
class StructModel(object):
  def __init__(self):
    ...
    self.line_df = pd.DataFrame( columns = ['i','j','ux','uy','uz','rx','ry','rz','MatProp','SecProp','Alpha','Length'])
  ...
  def GlobalStiff(self,k_matrix_elem): #will assign as k_matrix_eme(e) at for loop which will then look up the correct properties from the dataframe
